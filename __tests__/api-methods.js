...
describe('Client API responses', () => {
  ...
  it('should return valid keys when calling getConfiguration method', async () => {
  ...
  it('should return valid keys when calling getPopularMovies method', async () => {
    mock.onGet(urls.getPopularMovies).reply(200, getPopularMoviesJson);

    const response = await client.getPopularMovies();
  ...
  it('should return an error object when calling with invalid api key', async () => {
    mock.reset();
  ...
  it('should return an error object when calling a non-existent resource', async () => {
    mock.reset();

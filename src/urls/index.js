...
export const MOVIES_DELETE_RATING = '/movie/:id/rating';
...
export const MOVIES_LATEST = '/movie/latest';
export const MOVIES_LISTS = '/movie/:id/lists';
export const MOVIES_NOW_PLAYING = '/movie/now_playing';
export const MOVIES_POPULAR = '/movie/popular';
export const MOVIES_RATING = '/movie/:id/rating';
...
export const MOVIES_TOP_RATED = '/movie/top_rated';
export const MOVIES_TRANSLATIONS = '/movie/:id/translations';
export const MOVIES_UPCOMING = '/movie/upcoming';
